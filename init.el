...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (auto-complete ido-vertical-mode flycheck-package keyfreq golden-ratio gotham-theme helm-projectile dired-du org s undo-tree websocket yaml-mode hydra list-unicode-display alert diminish magit-popup nyan-mode imgur twittering-mode elmacro csv-mode all-the-icons flycheck helm helm-core package-build package-lint projectile restart-emacs smartparens web-mode o-blog org-page sudoku open-junk-file json-mode which-key ag with-editor yasnippet pallet php-mode f 2048-game ace-window rainbow-delimiters exec-path-from-shell use-package slack org-pomodoro synosaurus dokuwiki markdown-mode+ org2blog avy dokuwiki-mode xml-rpc haxe-imports helm-ag evil-smartparens org-journal monky magit evil better-defaults ##)))
